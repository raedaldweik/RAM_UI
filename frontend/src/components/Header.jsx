...
export default function Header() {
  ...
  return (
    <header className="app-header">
      {/* SAS logo — left */}
      <img className="brand-logo" src="/sas_logo.png" alt="SAS"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6"
          ...
          <div className="glass-card w-full max-w-[440px] p-7 animate-slide-up"
            ...
            <div className="flex items-center gap-3 mb-5">
              <img src="/sas_logo.png" alt="" className="w-10 h-10 rounded-lg" />
              <div>
            ...
            {signin.kind === 'code' ? (
              <>
                ...
                <div className="flex gap-2">
                  <input value={viyaCode} onChange={e => setViyaCode(e.target.value)}
                    ...
                    style={{ background: 'rgba(255,255,255,0.7)', borderColor: 'rgba(0,114,206,0.35)', color: 'var(--text)' }} />
              ...
              <>
                ...
                <div className="rounded-xl py-4 text-center mb-4"
                  style={{ background: 'rgba(0,114,206,0.07)', border: '1px dashed rgba(0,114,206,0.35)' }}>
