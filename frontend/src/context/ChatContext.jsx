...
const WELCOME = {
  role: 'assistant',
  type: 'text',
  content: "Welcome to the SAS Retrieval Agent Assistant. Pick an agent (or collection) from the dropdown above and ask me anything — answers are grounded in your indexed documents.",
};
